...
export class News extends Component {
  ...
  async componentDidMount() {
    console.log("cmd");
    let url = "https://newsapi.org/v2/top-headlines?country=us&category=business&apiKey=2573037d3ddc4215bd6e23dc261eb65c&page=1&pageSize=10";
  ...
  handlePrevClick = async () => {
    ...
    let url = `https://newsapi.org/v2/top-headlines?country=us&category=business&apiKey=2573037d3ddc4215bd6e23dc261eb65c&page=${this.state.page - 1}&pageSize=10`;
    let data = await fetch(url);
    let parsedData = await data.json();
    console.log(parsedData);
    this.setState({
